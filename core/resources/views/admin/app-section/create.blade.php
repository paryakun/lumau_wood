...
@extends('admin.master') @section('title') Add App Info  @endsection @section('css')
...
<div class="page-content-wrapper">
    <div class="page-content">
        <h3 class="page-title uppercase bold">Add App Info 
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <i class="fa fa-plus"></i> Add App Info 
                    </div>
